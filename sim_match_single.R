...
## pathoscope matches
#--------------------
path_matches <- read.csv(str_c(path_results_directory,"simulated_single.csv", sep= "/"), stringsAsFactors = F)
...
write.csv(path_matches,str_c(path_results_directory,"sim_single_matches.csv", sep="/"), row.names = F)
